#!/bin/bash
# Script de Traffic Control (TC) para ISP1
...
interfaceISP='wan70'; # Sub-interfaz VLAN 70 (ACTUALIZADO)
INTERFACE_IN='wan70'; # Sub-interfaz VLAN 70 (entrada) (ACTUALIZADO)
INTERFACE_OUT='ifb0'; # Interfaz virtual para el tráfico de bajada (download)
IP='192.168.70.3'; # IP del balanceador para este ISP (ACTUALIZADO)
